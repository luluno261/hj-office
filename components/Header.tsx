...
const navLinks = [
  ...
  { href: '/#services', label: 'Nos 5 Pôles d\'expertise', shortLabel: 'Pôles d\'expertise' },
  { href: '/#about', label: 'À propos', shortLabel: 'À propos' },
  { href: '/#team', label: 'Notre équipe', shortLabel: 'Équipe' },
